...
data.forEach((id)) => {
  let website = id.website;
  let email = id.email;
  websiteAndEmail.push([website, email]);
});
console.log("website and email "; websiteAndEmail);
...
const todo = data2.filter((task)) => (task.completed === false));
console.log(todo);

const user9tasks = data2.filter((task) => task.userID === 9);
...
data3.forEach((user)) => console.log(user.title.body);

// example with Trey, doesn't work either. Returning Boolean values instead of incomplete tasks
const toDos9 = data2.filter(arr => arr.userID === 9);
console.log(toDos9);
...
class Elephant extends Animal {
  constructor(name, color, size, age, location) {
